            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCustomerProductPrice" Class="form-control" runat="server" Text="0"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtSuperWholesalePrice" Class="form-control" runat="server" Visible="false" Text="0"></asp:TextBox>
