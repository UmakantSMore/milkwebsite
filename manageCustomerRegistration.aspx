<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="manageCustomerRegistration.aspx.cs" Inherits="manageCustomerRegistration" %>
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <asp:Button ID="Button1" runat="server" Text="Add New Customer Registration" CssClass="btn btn-danger" OnClick="btnAddNew_Click" />
         ...
         <table id="tblBank" class="display table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <asp:Repeater ID="repcustomer" runat="server" OnItemDataBound="repBank_ItemDataBound">
                            <ItemTemplate>
                                <tr>
