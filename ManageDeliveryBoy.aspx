<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="ManageDeliveryBoy.aspx.cs" Inherits="ManageDeliberyBoy" %>
      ...
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <asp:Button ID="Button1" runat="server" Text="Add New Delivery Boy" CssClass="btn btn-danger" OnClick="btnAddNew_Click" />
         ...
         <table id="tblBank" class="display table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        <asp:Repeater ID="repVendor" runat="server" OnItemDataBound="repBank_ItemDataBound">
                            <ItemTemplate>
                                <tr>
