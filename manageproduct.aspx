                            ...
                            <div class="col-md-6" style="text-align: right;">
                                <table>
                                    <tr>
                                        ...
                                        <%--<td>
                                            <label for="exampleInputPassword1">Checked / Unchecked</label></td>
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Width="10"></asp:Label></td>
                                        <td>
                                            <asp:DropDownList ID="ddlSelectChecked" Class="form-control" Width="80px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlSelectChecked_SelectedIndexChanged">
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center">Wholesaler Price</th>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td style="text-align: center; display:none">
                                                    <asp:TextBox ID="txtSuperWholesaleprice" Style="width: 80px" runat="server" CssClass="form-control" Text='<%# Eval("superwholesaleprice") %>'></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:TextBox ID="txtDealerPrice" Style="width: 70px" runat="server" CssClass="form-control" Text='<%# Eval("dealerprice") %>'></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:TextBox ID="txtWholesaleprice" Style="width: 70px" runat="server" CssClass="form-control" Text='<%# Eval("wholesaleprice") %>'></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                                                    <asp:TextBox ID="txtCustomerPrice" Style="width: 70px" runat="server" CssClass="form-control" Text='<%# Eval("customerprice") %>'></asp:TextBox>
                                                </td>
                                                <td style="text-align: center">
                                                    <%-- <asp:Label ID="Label3" runat="server" Text='<%# Eval("LandingPrice") %>'></asp:Label>--%>
                                                    <asp:TextBox ID="txtLandingPrice" Style="width: 70px" runat="server" CssClass="form-control" Text='<%# Eval("LandingPrice") %>'></asp:TextBox>
                                                </td>
                                                <td style="text-align: center; display: none">
