...
namespace BusinessLayer
{
    public class Cls_product_b
    {
        ...
        public bool Product_UpdatePrice(Int64 ProductId, decimal CustomerPrice, decimal DealerPrice, decimal DiscountPrice, decimal GST, Int32 StockQuantites, bool IsStock, bool IsActive, decimal Wholesaleprice, decimal SuperWholesaleprice, int StockAlertQuantites, bool isHot)
        {
            try
            {
                Cls_product_db objCls_product_db = new Cls_product_db();
                if (objCls_product_db.Product_UpdatePrice(ProductId, CustomerPrice, DealerPrice, DiscountPrice, GST, StockQuantites, IsStock, IsActive, Wholesaleprice, SuperWholesaleprice, StockAlertQuantites,isHot))
                {
                    return true;
                }
                else
