<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="addeditDeliveryBoy.aspx.cs" Inherits="addeditDeliberyBoy" %>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <div class="col-xs-6">
                                    ...
                                    <asp:TextBox ID="txtpassword" CssClass="form-control" runat="server" Rows="3" ></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtpassword" ValidationGroup="gg" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
