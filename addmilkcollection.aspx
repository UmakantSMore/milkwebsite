<%@ Page Title="" Language="C#" MasterPageFile="~/morya.master" AutoEventWireup="true" CodeFile="addmilkcollection.aspx.cs" Inherits="addmilkcollection" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-3">
                                    <label for="exampleInputEmail1">Farmer <%--<span style="color: red">*</span>--%> </label>
                                                ...
                                                <ItemTemplate>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtqty" ValidationGroup="gg" ValidationExpression="^-?([0-9]{0,9}(\.[0-9]{0,2})?|100(\.00?)?)$" ErrorMessage="*" Font-Bold="True" Font-Size="Large" />
