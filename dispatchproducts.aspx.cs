...
public partial class dispatchproducts : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {
                hPageTitle.InnerText = "Dispatch Products";
                Page.Title = "Dispatch Products";
    ...
    private void Bind()
    {
        ...
        dtproducts = (new Cls_product_b().SelectAll());
    ...
    private void Clear()
    {
        ...
        Repeater1.DataSource = (DataTable)ViewState["Products"];
        Repeater1.DataBind();
        //Repeater1.Visible = false;
    }
